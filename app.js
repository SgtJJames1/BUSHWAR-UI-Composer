(() => {
  ...
  function freshState() {
    return {
      ...
      handoff: { target: "Menu", layoutName: "BUSHWAR_ComposerLayout", layoutGuid: "" },
  ...
  function controllerSourceFor(classStem, layoutName, widgets, layoutGuid = "") {
    ...
    const layoutResourceName = normalizedLayoutGuid ? `{${normalizedLayoutGuid}}UI/layouts/${layoutName}.layout` : `UI/layouts/${layoutName}.layout`;
    const lines = [
      ...contextClasses,
  ...
  function makeWorkbenchPlan() {
    ...
    const layoutResourceReference = layoutGuid ? `{${layoutGuid}}UI/layouts/${layoutName}.layout` : `UI/layouts/${layoutName}.layout`;
    const controllerSource = controllerSourceFor(classStem, layoutName, runtimeScaffolds, layoutGuid);
    return {
